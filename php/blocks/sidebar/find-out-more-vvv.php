<div class="box">
	<h3>Find out more about Valet</h3>
	<?php
	if ( file_exists( '/vagrant/version' ) ) {
		...
		?>
		<p>You're running Valet <code><?php echo file_get_contents( '/vagrant/version' ); ?></code>, <strong>if</strong> there are updates available you can run <code>git pull</code> and reprovision to apply them</p>
		<?php
	}
	?>
